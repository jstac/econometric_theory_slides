...
\begin{frame}
    ...
    \begin{figure}
       \begin{center}
        \input{tikzfigs/vec_canon_x.tex}
...
\begin{frame}
    ...
    The pair are not linearly independent since $\boldx_2 = -2\boldx_1$
        ...
        \begin{center}
            \input{tikzfigs/vec_noncanon.tex}
        \end{center}
 \end{frame}
...
\begin{frame}
    ...
    \begin{figure}
       \begin{center}
        \resizebox{7.5cm}{!}{\input{tikzfigs/orth_comp.tex}}
...
\begin{frame}
    ...
    \begin{figure}
       \begin{center}
        \input{tikzfigs/orth_proj2D0.tex}
...
\begin{frame}
    ...
    \begin{figure}
       \begin{center}
        \input{tikzfigs/orth_proj2Dp.tex}
...
\begin{frame}
    ...
    \begin{figure}
       \begin{center}
        \input{tikzfigs/orth_proj2D.tex}
